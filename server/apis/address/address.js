...
const address = async (req, res) => {
  switch (req.method) {
    ...
    case "POST":
      ...
      break;
    case "PUT":
      await putAddress(req, res);
      break;
  }
};

const getAddress = Authenticated(async (req, res) => {
  try {
...
const checkAddress = Authenticated(async (req, res) => {
  try {
...
const putAddress = Authenticated(async (req, res) => {
  const authorization = get_cookies(req).token;
