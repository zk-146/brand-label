  ...
  return (
    <div className="termsofservice">
      <div className="termofservice__container">
        <h1 className="pageHeader header">Terms Of Service</h1>
        <hr />
        <div className="termofservice__content">
          <h3 className="termofservice__subheader"> OVERVIEW</h3>
          <p className="termofservice__para">
            This website is operated by BRANDLABEL. Throughout the site, the
            terms “we”, “us” and “our” refer to BRANDLABEL. BRANDLABEL offers
          ...
          <p className="termofservice__para">
            ...
            Our store is developed by Zaid Khan.{" "}
          </p>
          <h3 className="termofservice__subheader">
            {" "}
          ...
          <p className="termofservice__para">
            ...
            over networks. You agree not to reproduce, duplicate, copy, sell,
            resell or exploit any portion of the Service, use of the Service, or
            access to the Service or any contact on the website through which
            the service is provided, without express wrote permission by us.{" "}
          </p>
          <p className="termofservice__para">
          ...
          <p className="termofservice__para">
            ...
            case shall BRANDLABEL, our directors, officers, employees,
          ...
          <p className="termofservice__para">
            You agree to indemnify, defend and hold harmless BRANDLABEL and our
